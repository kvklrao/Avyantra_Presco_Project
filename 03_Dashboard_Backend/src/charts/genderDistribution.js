...
const GenderDistribution = async (req, res) => {
    ...
    if(range == 0 || range == 1){
      ...
      patient_general_infos.baby_gender,
      ...
      GROUP BY patient_general_infos.baby_date_of_admission ,patient_baby_investigations.blood_culture_report,patient_general_infos.baby_gender
   ...
   res.json({ results });
     ...
     patient_baby_investigations.blood_culture_report,patient_general_infos.baby_gender
     order by baby_adm_date,patient_baby_investigations.blood_culture_report`, {
     });
