...
const eosLosGraph = async (req, res) => {
    ...
    if(range == 0 || range == 1){
      ...
      patient_general_infos.baby_condition_yes_eos_los,
      ...
      and  patient_baby_investigations.blood_culture_report = 'Positive'
      GROUP BY patient_general_infos.baby_date_of_admission ,patient_baby_investigations.blood_culture_report,patient_general_infos.baby_condition_yes_eos_los
   ...
   res.json({ results });
     ...
     patient_baby_investigations.blood_culture_report,patient_general_infos.baby_condition_yes_eos_los
     order by baby_adm_date,patient_baby_investigations.blood_culture_report`, {
     });
