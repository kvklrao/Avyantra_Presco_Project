...
const graphCardStyle = {
    marginTop: '2%', height: '100%', padding: '10px'
}
...
export default class TypeOfDeliveryGraph extends Component {
    ...
    apply = function () {
        ...
        if (errors == false) {
            axios.get(
                process.env.REACT_APP_URL + '/typeOfDeliveryGraph?range=' + this.state.range + '&sepsis_status=' + this.state.sepsisStatus + '&date_from=' +
                ...
                if (this.state.range == 1) {
                    ...
                    for (var d = 0; d < rangedates.length; d++) {
                        for (var i = 0; i < this.state.data.length; i++) {
                            if (rangedates[d] === this.state.data[i].baby_adm_date) {
                                cesarean_delivery_count[d] = this.state.data[i].cesarean_delivery_count;
                                normal_delivery_count[d] = this.state.data[i].normal_delivery_count;
                            }
                            else {
                    ...
                    for (var i = 0; i < cesarean_delivery_count.length; i++) {
                        sum_normal_delivery_count = sum_normal_delivery_count + parseInt(cesarean_delivery_count[i]);
                    }
                    for (var i = 0; i < normal_delivery_count.length; i++) {
                        sum_cesarean_delivery_count = sum_cesarean_delivery_count + parseInt(normal_delivery_count[i]);
                    }
                                ...
                                <div >
                                    {this.state.data.length == 0 ?
                                        ...
                                        <Row justify='space-between'>
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12}>
                                                <Card title="Type of Delivery" style={graphCardStyle}>
