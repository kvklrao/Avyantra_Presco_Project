...
export default class GenderDistributionGraph extends Component {
    ...
    apply = function () {
        ...
        if (errors == false) {
            // console.log(process.env.REACT_APP_URL + '/genderDistribution?range=' + this.state.range + '&sepsis_status=' + this.state.sepsisStatus +
            ...
            axios.get(
                process.env.REACT_APP_URL + '/genderDistribution?range=' + this.state.range + '&sepsis_status=' + this.state.sepsisStatus +
                '&date_from=' + this.state.startDate + '&date_to=' + this.state.endDate +
                '&hospital_id=' + this.props.hospital_id + '&branch_id=' + this.props.branch_id +
                '&all_hospitals=' + localStorage.getItem('all_hospitals') + '&all_branches=' + localStorage.getItem('all_branches'),
                ...
                if (this.state.range == 1) {
                    ...
                    for (var d = 0; d < rangedates.length; d++) {
                        for (var i = 0; i < this.state.data.length; i++) {
                            if (rangedates[d] === this.state.data[i].baby_adm_date) {
                                male_count[d] = this.state.data[i].male_count;
                                female_count[d] = this.state.data[i].female_count;
                            }
                            else {
                    ...
                    for (var i = 0; i < male_count.length; i++) {
                        sum_male_count = sum_male_count + parseInt(male_count[i]);
                    }
                    for (var i = 0; i < female_count.length; i++) {
                        sum_female_count = sum_female_count + parseInt(female_count[i]);
                    }
                    ...
                    <Card>
                        <Form>
                            <Row>
                                ...
                                <Col span={4} xs={24} sm={12} md={12} lg={8} xl={4} xxl={4}>
                                    <div style={{ padding: 10 }}>
                                        <h6>Range</h6>
                                ...
                                <div >
                                    {this.state.data.length == 0 ?
                                        ...
                                        <Row justify='space-between'>
                                            ...
                                            <Col xs={24} sm={24} md={24} lg={12} xl={12} xxl={12}>
                                                <Card title="Sepsis status of Male and Female" style={graphCardStyle}>
