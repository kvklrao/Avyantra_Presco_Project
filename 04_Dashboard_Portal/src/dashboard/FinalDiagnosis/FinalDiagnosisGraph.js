...
let final_diagnosis_positive_count = [], final_diagnosis_negative_count = [];
let preliminary_diagnosis_positive_count = [], preliminary_diagnosis_negative_count = [];
let xaxis_dates = [], rangedates = [];
let startDate = '', endDate = '', quarterCal = '', errors = false;
export default class FinalDiagnosisGraph extends Component {
    constructor(props) {
        super(props);
    ...
    apply = function () {
        ...
        final_diagnosis_positive_count = []; xaxis_dates = []; final_diagnosis_negative_count = [];
        preliminary_diagnosis_positive_count = []; preliminary_diagnosis_negative_count = [];
        rangedates = [];
        if (errors == false) {
            axios.get(
