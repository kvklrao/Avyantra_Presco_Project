...
exports.savePatientModels = (req, res, next) => {
 ...
 // var baby_respiratory_support = "" + req.body.baby_resp.baby_respiratory_support
 // console.log(baby_respiratory_support)
...
exports.getAashaBaby =(req,res,next)=>{
  ...
  var query=` SELECT
  patient_infos.baby_name,patient_infos.mother_name,patient_infos.father_name,patient_infos.primary_contact_no,
  patient_infos.secondary_contact_no,patient_infos.createdAt,patient_infos.updated_by,patient_infos.address,
  patient_infos.city,patient_infos.state,patient_infos.pincode,patient_infos.nationality,patient_infos.email_id,
  patient_infos.study_id,patient_infos.active_flag AS STATUS,patient_infos.patient_id,
  patient_infos.created_by,patient_basic_infos.hospital_id,m_hospitals.hospital_name,
  m_hospitals.user_id,patient_basic_infos.baby_medical_record_number,
  patient_basic_infos.baby_mother_medical_record_number,patient_basic_infos.hospital_type,patient_basic_infos.id AS patient_basic_infos_id
  FROM
  patient_infos
  JOIN patient_basic_infos ON patient_basic_infos.id = patient_infos.study_id
  ...
  query = query+ ` ORDER BY patient_infos.createdAt DESC
